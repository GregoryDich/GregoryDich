...
10.1 You can create API keys (`sp_live_…`) in your account to use the Service from scripts and other software. A key acts as you: it spends your credits and is subject to your rate limits. We show the full key only once, when it is created.
