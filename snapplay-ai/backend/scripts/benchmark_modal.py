...
BENCH_APP_NAME = "snapplay-benchmark"
...
def local_pipeline(name: str) -> RunPipeline:
    ...
    settings = Settings(snapplay_pipeline=name)  # type: ignore[call-arg]
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--gpu", default=os.environ.get("SNAPPLAY_MODAL_GPU", "A10G"))
