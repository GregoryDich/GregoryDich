...
PRODUCTION: dict[str, Any] = {
    ...
    "auth_site_url": "https://snapplay.ai",
}
...
def test_production_accepts_a_public_https_site_url() -> None:
    assert Settings(**PRODUCTION).auth_site_url == "https://snapplay.ai"
    assert Settings(**{**PRODUCTION, "auth_site_url": "https://www.snapplay.ai/"}).auth_site_url
