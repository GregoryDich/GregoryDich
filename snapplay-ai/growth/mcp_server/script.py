    ...
    if angle == "speed":
        ...
        beats = [
            ...
            Beat(
                ...
                label="proof",
                voice=(
                    f"SnapPlay pulls the {stem_label} out, transcribes it, "
        ...
        tags = ["#producer", "#musicproduction", "#sampling", "#vst", "#snapplay"]
    elif angle == "bass":
        ...
        beats = [
            ...
            Beat(
                ...
                label="proof",
                voice=(
                    "Drop the clip, SnapPlay isolates the bass and hands you the MIDI, "
        ...
        tags = ["#bassline", "#beatmaking", "#producerlife", "#midi", "#snapplay"]
        ...
        tags = ["#sampleflip", "#flip", "#beats", "#producer", "#snapplay"]
    else:
        ...
        beats = [
            ...
            Beat(
                ...
                voice=(
                    ...
                    f"SnapPlay transcribes it to MIDI and maps it to the keys. {tempo}."
                ),
        ...
        tags = ["#tutorial", "#musicproduction", "#vst", "#daw", "#snapplay"]
...
def write_brief(metadata: dict[str, Any], angle: Angle) -> ScriptBrief:
    ...
    return ScriptBrief(
        ...
        cta_line=f"Try SnapPlay free — {CTA_TEXT}, no card required.",
        hashtags=tags,
