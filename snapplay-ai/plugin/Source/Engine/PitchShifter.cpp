...
#if SNAPPLAY_HAS_RUBBERBAND && defined (RUBBERBAND_API_MAJOR_VERSION) && defined (RUBBERBAND_API_MINOR_VERSION) \
    && (RUBBERBAND_API_MAJOR_VERSION > 2 || (RUBBERBAND_API_MAJOR_VERSION == 2 && RUBBERBAND_API_MINOR_VERSION >= 7))
 #define SNAPPLAY_RUBBERBAND_HAS_R3 1
#else
 #define SNAPPLAY_RUBBERBAND_HAS_R3 0
#endif
