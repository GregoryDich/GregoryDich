...
/**
 * SnapPlay AI — the plugin. Owns the parameter tree, the cloud session (ApiClient,
...
public:
    ...
    static constexpr const char* stateTreeType = "SnapPlayAI";
    ...
    SnapPlayAudioProcessor();
    ~SnapPlayAudioProcessor() override;
