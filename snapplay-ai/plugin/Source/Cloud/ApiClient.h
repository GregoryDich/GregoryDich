...
/**
 * Asynchronous HTTPS client for the SnapPlay API (docs/API_CONTRACT.md v2).
 *
...
public:
    ...
    struct Config
    {
        juce::String baseUrl { "https://api.snapplay.ai" };   ///< no trailing slash; routes are appended as "/v1/..."
        ...
        juce::String userAgent { "SnapPlayAI/" SNAPPLAY_VERSION_STRING };
    };
