...
/**
 * Dark look-and-feel for the SnapPlay AI editor: one palette shared by every component,
...
class SnapPlayLookAndFeel final : public juce::LookAndFeel_V4
{
public:
    SnapPlayLookAndFeel();
...
private:
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (SnapPlayLookAndFeel)
};
