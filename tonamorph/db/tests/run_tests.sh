...
#
# Overridable: PGBIN, TONAMORPH_TEST_PGDATA, TONAMORPH_TEST_PGPORT, TONAMORPH_TEST_PGUSER.
set -euo pipefail

PGBIN=${PGBIN:-/usr/lib/postgresql/16/bin}
PGDATA_DIR=${TONAMORPH_TEST_PGDATA:-/home/user/pgdata/tonamorph-test}
PGPORT=${TONAMORPH_TEST_PGPORT:-54329}
PGOWNER=${TONAMORPH_TEST_PGUSER:-pguser}
DBNAME=tonamorph_test
