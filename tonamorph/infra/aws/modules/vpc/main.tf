...
# Public subnets host the ALB and the single NAT gateway; private subnets host
# every ECS task and GPU instance.
...
# Keeps S3 traffic (ECR image layers, job assets) off the NAT gateway.
