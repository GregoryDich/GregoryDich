...
>
> Основной путь — рендер из Blender (`blender/fish.py`, см. `blender/README.md`).
> Этот файл — альтернатива: если хотите рыб из нейросети или с фото, сгенерируйте
> по промптам ниже и положите PNG с тем же именем — движок возьмёт их вместо рендера.
